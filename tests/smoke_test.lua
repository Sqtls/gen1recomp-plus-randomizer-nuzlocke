...
assert(mod.exports.project.status
    == "strict-encounters-dupes-shiny-static-and-gift-policies-permadeath-run-reports-mandatory-nicknames-level-caps-level-scaling-forced-set-mode-and-no-battle-items",
